...
def build_excel_reports(matches) -> bytes:
    """
    Planilha de partidas — formato exato da imagem de exemplo.
    ...
    FT_LOSE = Font(bold=True, color="FF6B6B", name="Calibri", size=11)
    FT_DRAW = Font(bold=True, color="FFD700", name="Calibri", size=11)
    FT_NORM = Font(color="C9D1D9", name="Calibri", size=10)
    FT_MUT  = Font(color="8B949E", name="Calibri", size=10)
