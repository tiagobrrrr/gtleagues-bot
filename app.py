...
DB_URL = os.getenv(
    "DATABASE_URL",
    "cockroachdb+psycopg2://tiagobr:HZm6H0YeIt2AUwk0LA4QXQ@fifa-gtleague-16958.jxf.gcp-europe-west1.cockroachlabs.cloud:26257/defaultdb?sslmode=verify-full&sslrootcert=system"
)
